...
export default function Location() {
  const schema = {
    ...
    "@id": "https://www.torridon-homes.co.uk/locations/north-berwick",
    "url": "https://www.torridon-homes.co.uk/locations/north-berwick",
    "telephone": "",
    "address": {
      "@type": "PostalAddress",
      ...
      <section className="container mx-auto px-6 max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-start mb-32">
          ...
          <div className="lg:col-span-5 bg-white/5 p-12 border border-white/10 backdrop-blur-sm">
            <h3 className="text-2xl font-serif text-torridon-gold mb-8 tracking-tight">Project Enquiries: North Berwick</h3>
