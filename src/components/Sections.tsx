          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4">
              <div className="h-64 overflow-hidden rounded-sm">
                <img src="https://images.unsplash.com/photo-1548141313-79d264f3317c?q=80&w=1974&auto=format&fit=crop" className="w-full h-full object-cover grayscale opacity-60 hover:scale-110 transition-transform duration-1000" alt="Scotland Landscape" />
              </div>
              <div className="h-48 overflow-hidden rounded-sm">
                <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?q=80&w=2070&auto=format&fit=crop" className="w-full h-full object-cover grayscale opacity-60 hover:scale-110 transition-transform duration-1000" alt="Scotland Architecture" />
              </div>
            </div>
            <div className="space-y-4 pt-12">
              <div className="h-48 overflow-hidden rounded-sm">
                <img src="https://images.unsplash.com/photo-1552526483-3765f0285223?q=80&w=2070&auto=format&fit=crop" className="w-full h-full object-cover grayscale opacity-60 hover:scale-110 transition-transform duration-1000" alt="Edinburgh City" />
              </div>
              <div className="h-64 overflow-hidden rounded-sm">
                <img src="https://images.unsplash.com/photo-1510620389141-ce393d258661?q=80&w=1932&auto=format&fit=crop" className="w-full h-full object-cover grayscale opacity-60 hover:scale-110 transition-transform duration-1000" alt="Coastal Scotland" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <Reveal>
            ...
            <p className="text-torridon-green/60 text-lg font-sans mb-10 leading-relaxed">
              Our operations are geographically focused to ensure rapid response times, local supply chain integration, and deep knowledge of specific regional planning nuances.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        <Reveal>
          ...
          <p className="text-torridon-green/70 text-lg font-sans mb-10 leading-relaxed max-w-xl">
            We are actively seeking land opportunities across the Central Belt. Whether urban infill, garden plots, or brownfield, we offer a transparent and professional appraisal process.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-12 h-12 bg-torridon-green text-torridon-gold flex items-center justify-center">
                <MapPin size={24} />
              </div>
              <div>
                <h4 className="font-serif text-torridon-green text-lg italic">Strategic Bias</h4>
                <p className="text-xs text-torridon-green/60">Focused on high-value Central Belt areas.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="flex-shrink-0 w-12 h-12 bg-torridon-green text-torridon-gold flex items-center justify-center">
              ...
              <div>
                <h4 className="font-serif text-torridon-green text-lg italic">Boutique Scale</h4>
                <p className="text-xs text-torridon-green/60">Maximum value from <12 dwelling sites.</p>
              </div>
            </div>
          </div>
          <a href="#contact" className="inline-block px-12 py-6 bg-torridon-green text-white font-sans uppercase tracking-widest text-xs font-bold hover:bg-torridon-gold hover:text-torridon-green transition-all duration-500 shadow-2xl">
            Submit Your Land Appraisal
          </a>
        </Reveal>
        
        <div className="relative h-[500px] md:h-[700px] overflow-hidden rounded-sm">
          <img src="https://images.unsplash.com/photo-1500382017468-9049fed747ef?q=80&w=1932&auto=format&fit=crop" className="w-full h-full object-cover scale-110 hover:scale-100 transition-transform duration-[3s]" alt="Scotland Land" />
          <div className="absolute bottom-8 left-8 bg-torridon-green p-10 text-white max-w-xs shadow-2xl">
            <p className="text-sm italic font-serif leading-relaxed">"Our mission is to respect the heritage of the land while building for the future of Scottish living."</p>
          </div>
        </div>
      </div>
    </section>
...
export const LandJourney = () => {
  const steps = [
    { step: "01", title: "Confidential Appraisal", desc: "Discrete, no-obligation assessment of your land's potential." },
    { step: "02", title: "Strategic Planning", desc: "Expert team navigates local planning to maximize site value." },
    { step: "03", title: "Acquisition", desc: "Transparent terms and efficient legal processes for a smooth transition." }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-3 gap-24">
        <div>
          <Reveal>
            ...
            <p className="text-torridon-green/60 font-sans mb-10 text-sm leading-relaxed">Partnerships built on transparency. Protecting your interests while unlocking incredible value.</p>
        ...
        <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-12 pt-12 lg:pt-0">
          {steps.map((item, i) => (
            <Reveal key={i}>
              <div className="relative pt-12 border-t border-torridon-gold/10">
                <span className="absolute top-4 left-0 text-4xl font-serif text-torridon-gold/20">{item.step}</span>
                <h4 className="text-xl font-serif text-torridon-green mb-4">{item.title}</h4>
                <p className="text-xs text-torridon-green/60 leading-relaxed font-sans">{item.desc}</p>
              </div>
            </Reveal>
          ))}
        </div>
    ...
    <section className="py-32 bg-torridon-cream overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
        <div className="relative group order-2 lg:order-1">
          <div className="absolute -inset-6 border border-torridon-gold/10 translate-x-4 translate-y-4 group-hover:translate-x-2 group-hover:translate-y-2 transition-transform duration-700" />
        ...
        <div className="order-1 lg:order-2">
          <Reveal>
            ...
            <h2 className="text-4xl md:text-6xl font-serif text-torridon-green mb-8 italic leading-tight text-right md:text-left">Architectural Ambition.</h2>
            <div className="space-y-6 text-torridon-green/70 font-sans leading-relaxed text-lg text-right md:text-left">
              ...
              <p>Having spent decades in the Scottish Central Belt, I recognized a gap for a developer who prioritizes quality over volume. By focusing on fewer than 12 dwellings, we ensure every detail meets my standard of excellence.</p>
            </div>
            <div className="mt-12 pt-8 border-t border-torridon-gold/20 flex items-center justify-end md:justify-start gap-6">
              <div>
                <div className="text-xl font-serif text-torridon-green italic">Iain Martin</div>
                <div className="text-[10px] uppercase tracking-widest text-torridon-gold font-bold">Managing Director</div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center relative z-10">
        <Reveal>
          ...
          <p className="text-white/60 text-lg font-sans mb-16 max-w-2xl mx-auto leading-relaxed">
            Partnering with professional investors to deliver boutique housing. Agile, high-quality, and high-return.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-left mb-20">
            {[
              { icon: TrendingUp, title: 'Market Expertise', desc: 'Deep Central Scotland dynamics.' },
              { icon: Shield, title: 'Risk Management', desc: 'Conservative, effective strategies.' },
              { icon: Users, title: 'Collaborative Vision', desc: 'Aligned goals in every project.' }
            ].map((item, i) => (
              <div key={i} className="p-10 border border-white/10 bg-white/5 backdrop-blur-sm group hover:border-torridon-gold transition-colors">
                <item.icon className="text-torridon-gold mb-6" size={32} />
                <h4 className="text-xl font-serif text-white italic mb-4">{item.title}</h4>
                <p className="text-sm text-white/40 leading-relaxed font-sans">{item.desc}</p>
              </div>
            ))}
          </div>
          <a href="#contact" className="inline-block px-12 py-6 border border-torridon-gold text-torridon-gold font-sans uppercase tracking-widest text-xs font-bold hover:bg-torridon-gold hover:text-torridon-green transition-all duration-500">
            Inquire About Joint Ventures
          </a>
        </Reveal>
      </div>
    </section>
  ...
  return (
    <section className="py-32 bg-white relative">
      <div className="max-w-5xl mx-auto px-6 text-center">
        <Reveal>
          <div className="inline-block p-4 rounded-full border border-torridon-gold/20 mb-8">
          ...
          <p className="text-torridon-green/60 text-lg font-sans mb-12 max-w-2xl mx-auto">
            Early access to financial projections and exclusive pre-launch opportunities.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button className="w-full sm:w-auto px-12 py-6 bg-torridon-green text-white font-sans uppercase tracking-widest text-xs font-bold hover:bg-torridon-gold hover:text-torridon-green transition-all shadow-2xl">
              Request Invitation
            </button>
          </div>
  ...
  return (
    <section className="py-32 bg-torridon-cream">
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
        <Reveal>
          <span className="text-torridon-gold uppercase tracking-widest text-xs font-sans mb-4 block font-bold">Journal</span>
          <h2 className="text-4xl md:text-5xl font-serif text-torridon-green italic leading-tight">Torridon Insights.</h2>
        </Reveal>
        ...
        {posts.map((post, i) => (
          <Reveal key={i}>
            <div className="group cursor-pointer">
              <div className="aspect-[16/11] overflow-hidden mb-6 relative rounded-sm shadow-xl">
                <img src={post.img} className="w-full h-full object-cover grayscale transition-all duration-1000 group-hover:grayscale-0 group-hover:scale-110" alt="Blog" />
                <div className="absolute top-4 left-4 bg-white/90 px-3 py-1 text-[9px] uppercase tracking-widest font-bold text-torridon-green">{post.category}</div>
              </div>
              <div className="text-[10px] uppercase tracking-widest text-torridon-gold font-sans mb-2">{post.date}</div>
              <h4 className="text-xl font-serif text-torridon-green group-hover:text-torridon-gold transition-colors duration-300 italic">{post.title}</h4>
            </div>
          </Reveal>
        ))}
      </div>
...
export const ImmersiveGallery = () => {
  ...
  return (
    <section className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4 h-[600px] md:h-[800px]">
        {images.map((img, i) => (
          <Reveal key={i} className={img.size}>
            <div className="group relative w-full h-full overflow-hidden rounded-sm shadow-2xl">
              <img src={img.url} className="w-full h-full object-cover grayscale transition-all duration-1000 group-hover:grayscale-0 group-hover:scale-105" alt="Gallery" />
...
export const Developments = () => {
  ...
  const projects = [
    ...
    { location: 'Stirling District', name: 'Ochil Collection', units: '8 Luxury Villas', img: 'https://images.unsplash.com/photo-1600607687940-4e2003e25d27?q=80&w=2070&auto=format&fit=crop', tag: 'In Planning' },
    { location: 'West Lothian', name: 'Linlithgow Mews', units: '4 Townhouses', img: 'https://images.unsplash.com/photo-1600566753190-17f0bb2a6c3e?q=80&w=2070&auto=format&fit=crop', tag: 'Upcoming' }
  ];
...
export const Collaborations = () => (
  <section className="py-24 bg-white border-y border-torridon-gold/10">
    <div className="max-w-7xl mx-auto px-6 md:px-12 text-center mb-16">
      <Reveal><span className="text-torridon-gold uppercase tracking-[0.3em] text-[9px] font-bold mb-4 block">The Network</span><h3 className="text-2xl font-serif text-torridon-green italic">Working with Scotland’s Finest.</h3></Reveal>
    </div>
    <div className="max-w-7xl mx-auto px-6 flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-40 grayscale">
      {['Architects', 'Planners', 'Artisans', 'Engineers', 'Landscapers'].map((p, i) => <Reveal key={i}><span className="text-xl md:text-2xl font-serif text-torridon-green tracking-tighter hover:text-torridon-gold transition-colors italic">[ {p} ]</span></Reveal>)}
    </div>
  </section>
);
...
export const FAQs = () => {
  const faqs = [
    { q: "Development timeframe?", a: "Typically 18-24 months for our boutique projects." },
    { q: "Evaluation process?", a: "Feasibility studies including market demand and planning constraints." },
    { q: "Investment models?", a: "Bespoke Joint Ventures and fixed-return funding." },
    { q: "Why <12 dwellings?", a: "To maintain the 'Torridon Standard' of bespoke architectural finish." }
  ];
  return (
    <section className="py-32 bg-white">
      <div className="max-w-4xl mx-auto px-6">
        <Reveal><div className="text-center mb-20"><h2 className="text-4xl font-serif text-torridon-green mb-6 italic">Common Enquiries.</h2><div className="w-12 h-[1px] bg-torridon-gold mx-auto" /></div></Reveal>
        <div className="space-y-12">
          {faqs.map((f, i) => (
            <Reveal key={i}>
              <div className="group"><h4 className="text-xl font-serif text-torridon-green mb-4 flex items-start gap-6"><span className="text-torridon-gold font-sans text-xs pt-1">0{i+1}</span>{f.q}</h4><p className="text-sm text-torridon-green/60 font-sans leading-relaxed pl-12 border-l border-torridon-gold/5 group-hover:border-torridon-gold transition-colors">{f.a}</p></div>
            </Reveal>
          ))}
        </div>
      </div>
...
export const Sustainability = () => (
  <section className="py-32 bg-torridon-cream relative overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 text-center">
      <Reveal>
        <span className="text-torridon-gold uppercase tracking-[0.3em] text-[10px] font-bold mb-6 block">The Future</span>
        <h2 className="text-4xl md:text-6xl font-serif text-torridon-green mb-8 italic text-torridon-gold">The Green Standard.</h2>
        <p className="text-torridon-green/60 max-w-2xl mx-auto font-sans text-lg mb-20 leading-relaxed">Luxury and sustainability are not mutually exclusive. Our 'Fabric First' approach ensures every home is as efficient as it is elegant.</p>
      </Reveal>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
        {[
          { title: "Passive Design", desc: "Optimizing light and thermal mass.", icon: <Trees className="text-torridon-gold mb-6" size={32} /> },
          { title: "Renewables", desc: "Heat pumps and solar as standard.", icon: <TrendingUp className="text-torridon-gold mb-6" size={32} /> },
          { title: "Local Sourcing", desc: "Prioritizing Scottish materials.", icon: <MapPin className="text-torridon-gold mb-6" size={32} /> }
        ].map((item, i) => (
          <Reveal key={i}>
            <div className="p-10 bg-white border-t-2 border-transparent hover:border-torridon-gold transition-all shadow-xl shadow-torridon-green/5">
              {item.icon}<h4 className="text-xl font-serif text-torridon-green mb-4 italic">{item.title}</h4><p className="text-sm text-torridon-green/60 font-sans">{item.desc}</p>
            </div>
          </Reveal>
        ))}
      </div>
  ...
  <section className="py-24 bg-torridon-green text-white">
    <div className="max-w-7xl mx-auto px-6 md:px-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-8">
        <Reveal><h2 className="text-3xl md:text-5xl font-serif italic">Strategic Locations.</h2></Reveal>
        <Reveal><p className="text-white/50 max-w-sm font-sans text-sm">Targeting prime sites across the most sought-after pockets of the Central Belt.</p></Reveal>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        {['Edinburgh', 'Stirling', 'Linlithgow', 'East Lothian', 'Dunbar', 'Falkirk', 'Livingston', 'Perthshire Border'].map((loc, i) => (
          <Reveal key={i}>
            <div className="group border-b border-white/10 pb-4 hover:border-torridon-gold transition-colors">
              <div className="text-torridon-gold/20 text-[10px] font-sans mb-2">0{i+1}</div>
              <div className="text-xl font-serif italic">{loc}</div>
            </div>
          </Reveal>
        ))}
      </div>
...
export const Newsletter = () => (
  <section className="py-32 bg-white text-center relative overflow-hidden">
    ...
    <Reveal>
      ...
      <p className="text-torridon-green/60 font-sans mb-12 max-w-lg mx-auto text-sm leading-relaxed px-6">Receive curated property insights, regional land data, and exclusive partnership opportunities.</p>
      <div className="flex flex-col sm:flex-row gap-4 justify-center px-6 max-w-2xl mx-auto">
        <input type="email" placeholder="Email Address" className="px-8 py-6 bg-torridon-cream border-none text-torridon-green outline-none focus:ring-1 ring-torridon-gold/30 font-sans text-sm w-full sm:flex-1" />
        <button className="px-12 py-6 bg-torridon-green text-white uppercase tracking-widest text-xs font-bold hover:bg-torridon-gold transition-all shadow-2xl">Subscribe</button>
      </div>
    </Reveal>
  </section>
);
